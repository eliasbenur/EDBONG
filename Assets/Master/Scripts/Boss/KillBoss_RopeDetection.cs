        ...
        initialPosition = Camera.main.transform.position;
            ...
            if (method == MethodToKill.Cut || method == MethodToKill.Surround)
            {
                ...
                if (num_trig >= num_triggered)
                {
                    ...
                    if (allPlayers[0].GetComponent<Player_Movement>().get_MovementX() != 0 || allPlayers[0].GetComponent<Player_Movement>().get_MovementX() != 0 /*&&  allPlayers[1].GetComponent<Player2_Movement>().moveX != 0 || allPlayers[1].GetComponent<Player2_Movement>().moveY != 0*/)
                    {
